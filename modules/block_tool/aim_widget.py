...
class AimBlock(QWidget):
    def __init__(self, parent=None, block=None):
        super(AimBlock, self).__init__(parent)
        self.block = block
        self.setupUI()
        self.connect()
    ...
    def setupUI(self):
        ...
        # ## SplineShape
        # self.aimShape_layout = QHBoxLayout()
        # self.aimShape_layout.setContentsMargins(8, 0, 0, 0)
        # self.main_layout.addLayout(self.aimShape_layout)
        #
        # self.aimShape_label = flatten_widget.MPointLabel(self)
        # self.aimShape_label.setFont(font)
        # self.aimShape_label.setText('Aim Shape')
        # self.aimShape_label.setFixedWidth(140)
        # self.aimShape_layout.addWidget(self.aimShape_label)
        #
        # self.aimShape_combo = flatten_widget.MComboBox(color=[59, 59, 59], border=1)
        # self.aimShape_combo.setFont(font)
        # self.aimShape_combo.addItems(['FK', 'IK', 'Spline', 'Main'])
